...
// 	$no_thread_komen = $_POST['no_thread_komen'];
	...
	mysqli_query($link,"INSERT INTO `thread_komen`(`no_thread`,`thread_komen_id`, `thread_komen_pesan`, `thread_komen_tanggal`) VALUES ('$no_thread','$thread_id','$thread_pesan','$thread_datetime')");
