...
// 	$no_thread		 = $_POST['no_thread'];
	...
	$modal = mysqli_query($link,"INSERT INTO `thread`(`thread_id`, `thread_subjek`, `thread_pesan`, `tanggal_upload`) VALUES ('$thread_id','$thread_subjek','$thread_pesan','$thread_datetime')");
    if(!$modal){
