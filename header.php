        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
				    <?php
                    if(!empty($_SESSION['admin_email']) || (!empty($_SESSION['member_email'])))
                    {?>
                    <li class="dropdown">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                <i class="fa fa-user-times fa-fw"></i>Hello, Guest
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="daftar.php"><i class="fa fa-pencil fa-fw"></i>Register</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                <?php
                }elseif(!empty($_SESSION['member_email'])){
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-user-times fa-fw"></i><?php echo ucwords($member_username); ?>
                                    <span class="caret"></span>
                                </a>
                            <ul class="dropdown-menu">
                                <li>
                                    ...
                                    <div class="navbar-footer">
                                        <div class="navbar-footer-content">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <a href="password_baru.php" class="btn btn-default btn-sm">Ganti Password</a>
                                                </div>
                                                <div class="col-md-6">
                    ...
                    elseif(!empty($_SESSION['admin_email']))
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-user-times fa-fw"></i>List
                                    <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-user-times fa-fw"></i> <?php echo ucwords($admin_username); ?>
                                    <span class="caret"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <div class="navbar-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    ...
                                                    <p class="text-muted small"><?php echo "$admin_email" ?></p>
                                                    <div class="divider"></div>
                                                    <a href="profil.php" class="btn btn-primary btn-sm active">View Profile</a>
                                                </div>
                                            </div>
