...
// 	$no_personality_komen = $_POST['no_personality_komen'];
	...
	$modal=mysqli_query($link,"INSERT INTO `personality_komen`(`no_personality`,`personality_komen_id`, `personality_komen_pesan`, `personality_komen_tanggal`) VALUES ('$no_personality','$personality_komen_id','$personality_komen_pesan','$personality_komen_datetime')");
